...
public class PublicTests extends TestCase {
	...
	assertTrue(TestingSupport.correctResults("pubTestAddingCustomers.txt",
	...
	assertTrue(TestingSupport.correctResults("pubTestAddingMedia.txt",
	                                         resultsBuffer.toString()));
    }
	...
	resultsBuffer.append(manager.getAllCustomersInfo());
	assertTrue(TestingSupport.correctResults("pubTestAddingToQueue.txt",
	                                         resultsBuffer.toString()));
    }
	...
	resultsBuffer.append(manager.getAllCustomersInfo());
	assertTrue(TestingSupport.correctResults("pubTestRemovingFromQueue.txt",
	                                         resultsBuffer.toString()));
    }
	...
	resultsBuffer.append(manager.getAllCustomersInfo());
	resultsBuffer.append(manager.getAllMediaInfo());
	assertTrue(TestingSupport.correctResults("pubTestProcessingRequestsOne.txt",
	                                         resultsBuffer.toString()));
    }
	...
	resultsBuffer.append(manager.getAllCustomersInfo());
	resultsBuffer.append(manager.getAllMediaInfo());
	assertTrue(TestingSupport.correctResults("pubTestProcessingRequestsTwo.txt",
	                                         resultsBuffer.toString()));
    }
	...
	resultsBuffer.append(manager.getAllCustomersInfo());
	resultsBuffer.append(manager.getAllMediaInfo());
	assertTrue(TestingSupport.correctResults("pubTestReturnMedia.txt",
	                                         resultsBuffer.toString()));
    }
	...
	assertTrue(TestingSupport.correctResults("pubTestSearchMedia.txt",
	                                         resultsBuffer.toString()));
    }
	...
	if ((albumTitle.length != albumCopiesAvailable.length)
	    && (albumCopiesAvailable.length != albumArtist.length)
