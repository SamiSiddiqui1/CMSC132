...
public class TestsSupport {
    ...
    /** Feel free to use the correctResults method while developing your own tests. Notice that if
     * you define text files with some expected results, the text files must be named starting with
     * "studentTest" and ending with the .txt extension. If you don't name files this way, then the
     * submit server will generate an authorization error.
     * 
     * @param filename
     * @param results
