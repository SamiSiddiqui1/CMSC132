...
public class PublicTests {
	...
	@Test
	public void testUMD() {
		String answer = WordFrequency.freq("http://www.cs.umd.edu/class/summer2015/cmsc132/projects/P3_WordFrequency/test1.html",20);
		assertTrue(TestsSupport.isCorrect("pubUMD.txt", answer));
	}
