...
/** This class represents the polymorphic tree. The implementation uses classes implementing the
 * Tree interface to represent the actual search tree. Some methods of this class has been
 * implemented for you. */
public class PolymorphicBST<K extends Comparable<K>, V> {
    ...
    /** Return a string representation of the tree. You don't need to implement this method. */
    public String toString() {

	return root.toString();
    }

    /** Return subset of TreeMap between the values fromKey-toKey. It will include fromKey and toKey
     * if they are found in the original map. The values for fromKey and toKey do not actually need
     * to be in the map. You can assume than fromKey is less than or equal to toKey.
     * 
	...
	tree.root = this.root.subTree(fromKey, toKey);
	return tree;
    }
    ...
    /** Performs the specified task on the tree using a right tree, root, left tree traversal.
     * 
