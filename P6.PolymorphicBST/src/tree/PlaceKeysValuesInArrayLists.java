...
/** This task places key/values in two arrays in the order in which the key/values are seen during
 * the traversal. If no keys/values are found the ArrayList will be empty (constructor creates two
 * empty ArrayLists).
 *
 * @param <K>
 * @param <V> */
